...
$string['diary_found_help'] = 'Wenn angehakt, schreiben Sie die selbst gefundenen oder erstellten Materialien in die dafür vorgesehene Box.';
$string['diary_found_text'] = 'Welche?';
$string['diary_goals_met'] = 'Habe ich meine Ziele für diese Lerneinheit erreicht?';
$string['diary_goals_met_text'] = 'Falls nein: Warum nicht?';
...
$string['diary_read'] = 'Bücher, Folien usw. gelesen';
...
$string['diary_title'] = 'Titel:';
$string['entries'] = 'Einträge';
$string['entry_date'] = 'Datum';
$string['diary_date'] = 'Startdatum und -zeit:';
...
$string['time_spend_help'] = 'Wird automatisch aus Startdatum und -zeit und Endzeit berechnet.';
$string['title_required'] = '<div class="alert alert-danger">Ein Titel ist erforderlich.</div>';
$string['today'] = 'Heute';
$string['teacher_view_info'] = 'Übersicht über die gesamte Anzahl der Einträge ins Lerntagebuch';
