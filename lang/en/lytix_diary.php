...
$string['diary_goals_met_text'] = 'If no: Why not?';
...
$string['diary_date'] = 'Start date and time:';
...
$string['time_spend'] = 'Time invested (min):';
$string['time_spend_help'] = 'Automatically calculated from start date and time, and end time';
$string['title_required'] = '<div class="alert alert-danger">A title for the entry is required.</div>';
$string['today'] = 'Today';
$string['teacher_view_info'] = 'Overview of the total number of learning diary entries';
